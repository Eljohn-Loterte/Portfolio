...
export default function Sidebar({ activeSection, isOpen, onClose, theme, onToggleTheme, onSelectSection, onGoHome }) {
  const [ghStats, setGhStats] = useState({
    ...
    monthDays: [],
    fullMonthName: new Date().toLocaleString('en-US', { month: 'long' }),
  });
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (data && data.contributions && Array.isArray(data.contributions)) {
            ...
            const fullMonthName = now.toLocaleString('en-US', { month: 'long' });
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        >
          <div className="sidebar-github-header">
            ...
            <span className="sidebar-github-month-badge">This Month</span>
          </div>

          <div className="sidebar-github-count">
            {ghStats.monthContributions.toLocaleString()} <span className="count-label">contributions in {ghStats.fullMonthName}</span>
          </div>
